...
const PRODUCTS = {
  Electronics: [
    ...
    { name: 'Portable Bluetooth Speaker', price: 59, sku: 'ELEC-SPK01', stock: 35, imageId: '1505740420928-5e560c06d30e' },
  ],
  Shoes: [
    ...
    { name: 'Running Sport Shoes', price: 84, sku: 'SHOE-RUN01', stock: 30, imageId: '1542291026-7eec264c27ff' },
  ],
  Clothes: [
    ...
    { name: 'Cotton Hoodie', price: 45, sku: 'CLTH-HOOD01', stock: 40, imageId: '1489987707025-afc232f7ea0f' },
  ],
  'Bags & Luggage': [
    ...
    { name: 'Weekend Duffel Bag', price: 69, sku: 'BAG-DUF01', stock: 25, imageId: '1553062407-98eeb64c6a62' },
  ],
  Watches: [
    ...
    { name: 'Leather Strap Watch', price: 119, sku: 'WATCH-LTH01', stock: 18, imageId: '1524805444758-089113d48a6d' },
  ],
  Jewelry: [
    ...
    { name: 'Gold Pendant Necklace', price: 89, sku: 'JEWL-NECK01', stock: 22, imageId: '1573408301185-9146fe634ad0' },
  ],
  'Beauty & Fragrance': [
    ...
    { name: 'Body Lotion Set', price: 29, sku: 'BEAU-LOT01', stock: 30, imageId: '1541643600914-78b084683601' },
  ],
  'Home & Furniture': [
    ...
    { name: 'Wooden Coffee Table', price: 249, sku: 'HOME-TBL01', stock: 10, imageId: '1555041469-a586c61ea9bc' },
  ],
  'Kitchen & Dining': [
    ...
    { name: 'Stainless Steel Cookware Set', price: 149, sku: 'KTCH-COOK01', stock: 14, imageId: '1495521821757-a1efb6729352' },
  ],
  'Sports & Outdoors': [
    ...
    { name: 'Adjustable Dumbbell Set', price: 99, sku: 'SPRT-DUMB01', stock: 20, imageId: '1546519638-68e109498ffc' },
  ],
  'Pet Supplies': [
    ...
    { name: 'Pet Chew Toy Bundle', price: 16, sku: 'PET-TOY01', stock: 45, imageId: '1518717758536-85ae29035b6d' },
  ],
  'Baby & Kids': [
    ...
    { name: 'Kids Puzzle Set', price: 19, sku: 'BABY-PUZ01', stock: 34, imageId: '1522771930-78848d9293e8' },
  ],
  'Garden & Tools': [
    ...
    { name: 'Pruning Shears Set', price: 22, sku: 'GRDN-PRUN01', stock: 30, imageId: '1416879595882-3373a0480b5b' },
  ],
  'Phone Accessories': [
    ...
    { name: 'Wireless Charging Pad', price: 24, sku: 'PHON-CHRG01', stock: 60, imageId: '1592286927505-1def25115558' },
  ],
  Automotive: [
    ...
    { name: 'Car Phone Mount', price: 17, sku: 'AUTO-MOUNT01', stock: 40, imageId: '1503376780353-7e6692767b70' },
  ],
  'Office & School Supplies': [
    ...
    { name: 'Ergonomic Desk Lamp', price: 33, sku: 'OFFC-LAMP01', stock: 28, imageId: '1554224155-6726b3ff858f' },
  ],
  'Health & Wellness': [
    ...
    { name: 'Resistance Bands Set', price: 21, sku: 'HLTH-BAND01', stock: 36, imageId: '1611930022073-b7a4ba5fcccd' },
  ],
  'Musical Instruments': [
    ...
    { name: 'Acoustic Guitar', price: 229, sku: 'MUSC-ACO01', stock: 6, imageId: '1550985616-10810253b84d' },
  ],
  'Toys & Games': [
    ...
    { name: 'Wireless Game Controller', price: 39, sku: 'TOYS-CTRL01', stock: 25, imageId: '1607853202273-797f1c22a38e' },
  ],
  'Outdoor & Camping': [
    ...
    { name: 'Portable Camping Stove', price: 42, sku: 'OUTD-STOVE01', stock: 20, imageId: '1487730116645-74489c95b41b' },
  ],
};
